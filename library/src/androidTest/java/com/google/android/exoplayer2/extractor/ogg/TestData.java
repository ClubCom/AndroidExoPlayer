...
/* package */ final class TestData {
  ...
  public static byte[] buildOggHeader(int headerType, long granule, int pageSequenceCounter,
    ...
    return TestUtil.createByteArray(
        ...
        headerType,
<<<<<<< HEAD:library/src/androidTest/java/com/google/android/exoplayer/extractor/ogg/TestData.java
        (int) (granule >> 0) & 0xFF,
=======
        (int) (granule) & 0xFF,
>>>>>>> google/release-v2:library/src/androidTest/java/com/google/android/exoplayer2/extractor/ogg/TestData.java
        (int) (granule >> 8) & 0xFF,
        (int) (granule >> 16) & 0xFF,
        (int) (granule >> 24) & 0xFF,
        (int) (granule >> 32) & 0xFF,
