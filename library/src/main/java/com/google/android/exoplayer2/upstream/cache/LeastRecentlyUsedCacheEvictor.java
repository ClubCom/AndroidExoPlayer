...
public final class LeastRecentlyUsedCacheEvictor implements CacheEvictor, Comparator<CacheSpan> {
  ...
  @Override
<<<<<<< HEAD:library/src/main/java/com/google/android/exoplayer/upstream/cache/LeastRecentlyUsedCacheEvictor.java
  public void onStartFile(Cache cache, String key, long position, long length) {
    evictCache(cache, length);
=======
  public void onStartFile(Cache cache, String key, long position, long maxLength) {
    evictCache(cache, maxLength);
>>>>>>> google/release-v2:library/src/main/java/com/google/android/exoplayer2/upstream/cache/LeastRecentlyUsedCacheEvictor.java
  }
