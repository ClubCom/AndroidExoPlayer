...
<<<<<<< HEAD:library/src/main/java/com/google/android/exoplayer/util/ParsableByteArray.java
  /** Reads the next three bytes as a signed value in little endian order. */
=======
  /**
   * Reads the next three bytes as a signed value in little endian order.
   */
>>>>>>> google/release-v2:library/src/main/java/com/google/android/exoplayer2/util/ParsableByteArray.java
