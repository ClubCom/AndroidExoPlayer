...
/* package */ final class VbriSeeker implements Mp3Extractor.Seeker {
  ...
  public static VbriSeeker create(MpegAudioHeader mpegAudioHeader, ParsableByteArray frame,
    ...
    for (int index = 1; index < timesUs.length; index++) {
      ...
      positions[index] =
<<<<<<< HEAD:library/src/main/java/com/google/android/exoplayer/extractor/mp3/VbriSeeker.java
...
>>>>>>> google/release-v2:library/src/main/java/com/google/android/exoplayer2/extractor/mp3/VbriSeeker.java
    }
